...
class TestSystemTreeNode(unittest.TestCase):
    ...
    def test_navigateToNode_nonexisting_node(self):
        self.assertRaises(KeyError, self.root.navigateToNode, "bad/node/from/start")
        self.assertRaises(KeyError, self.root.navigateToNode, "2/3/bad/node")
    ...
    def _perform_update_with_regex(self, node, parentPath, regex, expectedResult):
    ...
    def test_update_valid_regex(self):
        ...
        expectedResult = 21 - 6
        self._perform_update_with_regex(self.root, "", "1/2/5/6", expectedResult)
    ...
    def test_update_parent_path(self):
        ...
        self._perform_update_with_regex(self.root, "invalid/parent/path", "1/2", 21)
